            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Header Management</h3>

                        <a href="{{ route('header.create') }}" class="btn btn-success btn-sm float-right">
                            ...
                            @foreach($headers as $header)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a class="" href="{{ route('header.show',$header->id) }}"
                                               style="margin-right: 7px">
                                                <span class="fa fa-eye"></span>
                                            </a>

                                            <a class="" href="{{ route('header.edit',$header->id) }}"
